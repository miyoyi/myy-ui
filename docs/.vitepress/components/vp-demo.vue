...
.container {
  ...
  border-radius: var(--myy-border-radius-base);
}
...
.demo {
  .menu {
    border-radius: var(--myy-border-radius-base) var(--myy-border-radius-base) 0 0;
    height: @menu-height;
...
.source-code {
  ...
  .hide-code-btn {
    border-top: 1px solid var(--vp-custom-block-details-border);
    border-radius: 0 0 var(--myy-border-radius-base) var(--myy-border-radius-base);
    position: sticky;
    bottom: 0;
    height: 40px;
    display: flex;
